...
// Define rotas para o controlador de usuários
router.post('/registration', userController.registration); // Rota para registro de usuários, chamando o método de registro do controlador de usuários
